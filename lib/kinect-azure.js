const kinect = require('node_modules/kinect_azure/build/Release/kinectAzure.node');
...
class KinectAzure {
  ...
  */
  setColorControl(options) { return kinect.setColorControl(options); }

  setAutoExposure() {
    this.setColorControl({command: KinectAzure.K4A_COLOR_CONTROL_EXPOSURE_TIME_ABSOLUTE, mode: KinectAzure.K4A_COLOR_CONTROL_MODE_AUTO, value: 0});
  }

  setExposure(value) {
    this.setColorControl({command: KinectAzure.K4A_COLOR_CONTROL_EXPOSURE_TIME_ABSOLUTE, mode: KinectAzure.K4A_COLOR_CONTROL_MODE_MANUAL, value: value});
  }
  ...
  setBrightness(value = 128) {
    this.setColorControl({command: KinectAzure.K4A_COLOR_CONTROL_BRIGHTNESS, mode: KinectAzure.K4A_COLOR_CONTROL_MODE_MANUAL, value: value});
  }
   ...
   */
  setContrast(value) {
    this.setColorControl({command: KinectAzure.K4A_COLOR_CONTROL_CONTRAST, mode: KinectAzure.K4A_COLOR_CONTROL_MODE_MANUAL, value: value});
  }
   ...
   */
  setSaturation(value) {
    this.setColorControl({command: KinectAzure.K4A_COLOR_CONTROL_SATURATION, mode: KinectAzure.K4A_COLOR_CONTROL_MODE_MANUAL, value: value});
  }
   ...
   */
  setSharpness(value) {
    this.setColorControl({command: KinectAzure.K4A_COLOR_CONTROL_SHARPNESS, mode: KinectAzure.K4A_COLOR_CONTROL_MODE_MANUAL, value: value});
  }
  ...
  setWhiteBalance(value) {
    this.setColorControl({command: KinectAzure.K4A_COLOR_CONTROL_WHITEBALANCE, mode: KinectAzure.K4A_COLOR_CONTROL_MODE_MANUAL, value: value});
  }
  ...
  setBacklightCompensation(value) {
    this.setColorControl({command: KinectAzure.K4A_COLOR_CONTROL_BACKLIGHT_COMPENSATION, mode: KinectAzure.K4A_COLOR_CONTROL_MODE_MANUAL, value: value});
  }
   ...
   */
  setGain(value) {
    this.setColorControl({command: KinectAzure.K4A_COLOR_CONTROL_GAIN, mode: KinectAzure.K4A_COLOR_CONTROL_MODE_MANUAL, value: value});
  }
  ...
  setPowerlineFrequency(value) {
    this.setColorControl({command: KinectAzure.K4A_COLOR_CONTROL_POWERLINE_FREQUENCY, mode: KinectAzure.K4A_COLOR_CONTROL_MODE_MANUAL, value: value});
  }
